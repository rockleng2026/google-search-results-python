...
from search_engine import search, fetch_url
...
def web_search():
    ...
    logger.info(f"[API] web_search called with q='{query}', num={num_results}, engines={engines}")
...
def web_fetch():
    ...
    logger.info(f"[API] web_fetch called with url='{url}'")
